      ...
      <div className="bg-gradient-to-b flex flex-col justify-around from-gray-700 px-8 py-6 h-[26rem] overflow-hidden to-gray-900 aspect-square rounded-3xl m-auto ">
        {step === "step1" && (
          <>
            ...
            <div
              className="flex flex-row py-3 justify-around w-auto"
            >
            ...
            <button
              ...
              className="bg-orange-500 text-white w-full py-3 rounded-3xl  hover:bg-white hover:text-orange-500"
            >
              Submit
            </button>
          </>
  ...
  return (
    <>
      <button
        ...
        } text-center hover:bg-orange-500 hover:text-white justify-center p-3 rounded-full`}
      >
...
function Result({ rating }: { rating: number }) {
  return (
    <Slide direction="left" in={true} mountOnEnter>
      ...
      text-orange-500 text-sm bg-slate-600 justify-center py-1 px-3 rounded-full"
        >
